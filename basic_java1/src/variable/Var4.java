...
public class Var4 {
    ...
    public static void main(String[] args) {
        ...
        // 2. 규칙
        // 자바에서 사용하는 예약어는 변수로 사용할 수 없다.
        //int if = 10; if는 예약어라서 변수 이름으로 사용 할 수 없다.
        // int, double, char, for, while, if... 등은 사용 x

        // 3. 규칙
        // 변수 이름은 숫자로 시작x
        // int 30age;
        // int 5age;
        int tel30box; //단어 중간 또는 끝에는 숫자 사용 가능

        // 4. 규칙
        // 특수 문자는 _ (언더바) , $(달러) 표기만 사용 가능
        int _count;
        int $tel;
        // int !abc;         ! 사용불가
        int count_10;
